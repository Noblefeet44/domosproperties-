...
export const INITIAL_PROPERTIES: Property[] = [
  {
    ...
    amenities: ["24/7 Industrial Borehole Water", "Prepaid Electricity Meter (PHCN)", "24/7 Gated Security Guard", "Tiled Flooring & POP Ceilings", "Reading Study Desk & Chair", "En-Suite Bathroom & Water Heater", "Daily Waste Management"],
    featured: true,
  ...
  },
  {
    ...
    amenities: ["Fenced Compound & Security Gate", "Solar Power & Inverter Backup", "24/7 Industrial Borehole Water", "Kitchenette with Sink & Cabinets", "Ample Car & Bike Parking", "Burglar Proofed Windows"],
    featured: true,
    agentPhone: "07073537007",
  ...
  },
  {
    ...
    amenities: ["En-Suite Bathroom & Water Heater", "Prepaid Electricity Meter (PHCN)", "Solar Power & Inverter Backup", "24/7 Gated Security Guard", "Built-in Wardrobes & Storage", "Close to Campus Shuttle Bus Stop"],
    featured: true,
    agentPhone: "07073537007",
  ...
  },
  {
    ...
    amenities: ["Paved Compound & Security Gate", "24/7 Industrial Borehole Water", "Standby Generator Backup", "Kitchenette with Sink & Cabinets", "Reading Study Desk & Chair", "Burglar Proofed Windows"],
    featured: false,
    agentPhone: "07073537007",
