  ...
  return (
    <nav className="sticky top-0 z-40 w-full border-b border-sky-200/50 dark:border-slate-800/60 glass shadow-xs px-4 sm:px-8 py-3 flex items-center justify-between">
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[9px] font-extrabold uppercase tracking-widest text-sky-600 dark:text-sky-400">
            GLOBAL LIMITED • MULTI-DIRECTORY PORTAL
          </span>
        </div>
      </div>

      {/* Main Nav Links (Directory Tabs) */}
      ...
      <div className="flex items-center gap-2.5">
        ...
        {/* User Account / Mobile Navigation Dropdown */}
        <div className="relative">
          ...
          {dropdownOpen && (
            <>
              ...
              />
              <div className="absolute right-0 mt-2.5 w-64 rounded-2xl glass border border-sky-200 dark:border-slate-800 shadow-xl p-2.5 z-40 animate-in fade-in slide-in-from-top-2 duration-150">
                <div className="px-3.5 py-2.5 mb-1.5 border-b border-sky-100 dark:border-slate-800">
                  ...
                  <p className="text-xs font-bold text-slate-800 dark:text-slate-100">Directories Navigation</p>
                </div>
                ...
                <div className="border-t border-sky-100 dark:border-slate-800 mt-2 pt-2 space-y-1">
                  <button
                    ...
                    className="w-full text-left px-3.5 py-2 rounded-lg text-xs font-medium hover:bg-sky-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 flex items-center justify-between cursor-pointer"
                  >
