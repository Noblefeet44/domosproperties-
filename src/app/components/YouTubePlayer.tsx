...
export default function YouTubePlayer({
  ...
  // If activeVideoId is present, it's a YouTube video embed
  if (activeVideoId) {
  ...
  // If url is present but NOT a YouTube video (e.g., direct Telegram MP4 video upload), render direct HTML5 video player
  if (url) {
    return (
      <div className={`relative w-full aspect-video rounded-xl overflow-hidden bg-slate-950 border border-slate-800 shadow-xl ${className}`}>
        <video
